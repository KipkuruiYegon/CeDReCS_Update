...
<h2 class="text-center bg-secondary text-white shadow-sm col-sm-12 p-2" style="text-decoration: underline;">Received Reports</h2>
...
if ($result->num_rows > 0) {
  ...
  while ($row = $result->fetch_assoc()) {
    ...
    echo '<tr>
            ...
            <td>
            <a type="button" class="btn btn-success" href="./view_report_details.php">Publish <i class="bi bi-box-arrow-up-right"></i></a>
            </td>
