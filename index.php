...
<div class="container-fluid mt-4 mb-4 " style="opacity: 1;" >
   ...
   <div class="row shadow text-center"  >
    <div class="col-sm-12 p-5 bg-white">
      <h2 class="fw-bold" style="font-family: Fugit;">Welcome to the Center for Data Research and Cyber Security</h2>
      <p class="lead">
        The Center for Data Research and Cyber Security (CeDReCS) is situated at Dedan Kimathi University
        of Technology. CeDReCS is dedicated to advancing data research, data governance, and cyber security.
        Through interdisciplinary collaboration and cutting-edge research, we drive transformative advancements
        to ensure a secure and trustworthy digital future. Our focus areas include data research projects
         data governance and security, data applications, and the development of cyber security applications.
         We are committed to responsible data use, privacy protection, and equipping individuals and organizations
         with the skills needed to address the challenges of the digital age.
      </p>

    </div>
<!--   
  <div class="col-sm- p-5 imgdescribe1">
...
<div class="row shadow" >
  ...
  <div class="col-md-4 p-5 bg-white img-welcome">
    ...
    <p class="lead">
      ...
      challenges and contribute to the development of a secure and data-driven society.
    </p>
...
<br>
  ...
  <div class="row shadow" >
    ...
    <div class="col-md-12 p-5 bg-white ">
      <h2 class="fw-bold text-center" style="font-family: Fugit;" ><i class="bi bi-people-fill"style="font-size: 2rem;"></i> Patnerships</h2>
      <p class="lead">We are actively seeking collaborative partnerships to drive innovation in data research and cybersecurity. 
        Join us in shaping the future of the digital landscape by leveraging our expertise and resources. Together, we can create impactful solutions 
        and address the evolving challenges of the data-driven world. Contact us to explore partnership opportunities and make a lasting impact.
      </p>
      <br>
      <div class="container">
